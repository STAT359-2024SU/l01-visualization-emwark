...
We can view these differences more easily by making separate visuals per gender. Here, we can find a little more clarity between gender category. However, it is still difficult to really discern anything valuable here.
